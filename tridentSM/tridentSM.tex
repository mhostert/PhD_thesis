...
\section{Overview of neutrino trident production}
...
%
%%%%%%%%%%%% SM DIAGRAMS %%%%%%%%%%%%%%%%
\input{tridentSM/diagramsSM.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
