...
\begin{table}[h]
 ...
 \hline
  ...
  U$(1)_Y$ & $1/6$ & $-1/2$ & $-2/3$ & $1/3$ & $1$ & & $1/2$ \\
  \hline
 \end{tabular}
 \caption[SM field content]{The representation of the left-handed Weyl fields and the complex scalar under the SM gauge group. The last row stands for the U$(1)_Y$ charge.\label{tab:SMcharges}}
\end{table}
