...
\hypersetup{
pdfinfo={
   Title={Hidden Physics at the Neutrino Frontier},
   Author={Matheus Hostert},
   ModDate={D:\pdfdate},
   Subject={Particle Physics},
   Keywords={neutrinos;dark sectors;trident;neutrino-electron;miniboone;minerva;CHARM-II;nustorm;sterile}
}}
\fi
% ------------------------------------------------------------------------------------------
...
\bibliography{introduction/introduction,%
		theory/theory,%
		tridentSM/tridentSM,%
		Zprime_scattering/Zprime_scattering,%
		dark_nus/three_portals,%
		dark_nus/nu_masses,%
		miniboone/miniboone,%
		appendices/loop_masses,%
		nustorm/nustorm}
